...
logo='''
\033[1;94m ┈┈┈┈╱▔▔▔▔╲┈┈┈┈☞☞☞☞☞☞\033[1;91m☜☜☜☜☜┈┈┈┈╱▔▔▔▔╲┈┈┈┈
\033[1;94m ┈┈┈▕▕RAJPU7▏▏┈┈┈☞☞☞☞☞☞\033[1;91m☜☜☜☜☜┈┈┈▕▕RAJPU7▏▏┈┈┈
\033[1;94m ┈┈┈▕▕▂╱╲▂▏▏┈┈┈☞☞☞☞☞☞\033[1;91m☜☜☜☜☜┈┈┈▕▕▂╱╲▂▏▏┈┈┈
\033[1;94m ┈┈┈┈╲┊┊┊┊╱┈┈┈┈\033[1;94mROYAL_RAJPUT.\033[1;91m┈┈┈┈╲┊┊┊┊╱┈┈┈┈
\033[1;96m ┈┈┈┈▕╲▂▂╱▏┈┈┈┈☞☞☞☞☞☞\033[1;91m☜☜☜☜☜┈┈┈┈▕╲▂▂╱▏┈┈┈┈
\033[1;96m ╱▔▔▔▔┊┊┊┊▔▔▔▔╲☞☞☞☞☞☞\033[1;91m☜☜☜☜☜╱▔▔▔▔┊┊┊┊▔▔▔▔╲
\033[1;96m................\033[1;93mROYAL_RAJPUT\033[1;91m...............
\033[1;96m................\033[1;93m✬🄵🄰🄲🄴🄱🄾🄾🄺✬\033[1;91m..............

\033[1;96m░░░░░░░░░░░░░░░░░░░░░░░░░░░░░░░░░░░░░░░░░░░░░

\033[1;91m☞ Auther     : ROYAL RAJPU7 
\033[1;92m☞ WhatsApp   : +12134788177
\033[1;95m☞ Facebook    : https://www.facebook.com/100002883369548
...
def menu():
	...
	print (S + 50*'-')
	print
	print (S + '[' + P + '☞1' + S + ']' + S + ' सबसे तेज क्लोनिंग अपडेट ')
	print (S + '[' + P + '☞2' + S + ']' + S + ' Update ROYAL_RAJPUT Tool')
	print (S + '[' + P + '☞3' + S + ']' + S + ' ROYAL_RAJPUT WhatsApp Group')
...
def mb():
	...
	if bm =='':
	    ...
	    os.system('rm -rf $URDAD/ROYAL_RAJPUT')
	    os.system('cd $URDAD && git clone https://github.com/ssrrajput/Royalrajput')
	    cb()
	    print (logo)
	    psb('☆10%')
	    psb('☆☆20%')
	    ...
	    psb('WhatsApp Num +12134788177✓')
	    psb('WellCome To ROYAL_RAJPUT')
	    psb('Congratulations ROYAL_RAJPUT Tool Has Been Updated Successfully')
	    psb('🔓User Name☆ 108108✓')
	    psb('🔓Password ☆ 108108✓')
	    psb('FOLLOW Me on facebook https://www.facebook.com/100002883369548✓')
	    psb('Please Login Again')
	    time.sleep(2)
	    os.system('cd $URDAD/ROYAL_RAJPUT && python2 ssr108.py')
	elif bm =='3':
	    os.system('xdg-open https://www.facebook.com/100002883369548')
	    menu()
	elif bm =='4':
...
def pak():
	...
	cb()
	print (logo)
	print (S + '[' + P + '☞1' + S + ']' + P + ' फ्रेंड लिस्ट से क्लोन करो')
	print (S + '[' + P + '☞2' + S + ']' + P + ' पब्लिक से क्लोन करो')
	print (S + '[' + Y + '☞3' + S + ']' + Y + ' फ़ाइल से क्लोन करो')
	print (S + '[' + R + '☞0' + S + ']' + R + ' पीछे जाए')
	print
	print (S + 50*'-')
	print
	pb()
